...
- (IBAction)alertshow:(id)sender {
    ...
    [AlertHelp alertWith:@"这是标题" message:@"这是消息内容哈哈哈" funBtns:@{@"确定":sureHandle} cancelBtn:@"取消" alertStyle:UIAlertControllerStyleAlert cancelAction:nil];
}
- (IBAction)alertshow1:(id)sender {
    ...
    [AlertHelp alertWith:@"这是标题" message:@"这是消息内容哈哈哈" funBtns:@{@"按钮一":sureHandle,@"按钮二":cancleHandle} cancelBtn:@"取消" alertStyle:UIAlertControllerStyleAlert cancelAction:nil];
}
- (IBAction)alertshow2:(id)sender {
    ...
    [AlertHelp alertWith:@"这是标题" message:@"这是消息内容哈哈哈" funBtns:@{@"按钮一":sureHandle,@"按钮二":cancleHandle} cancelBtn:@"取消" alertStyle:UIAlertControllerStyleActionSheet cancelAction:nil];
}
- (IBAction)alertshow3:(id)sender {
    [AlertHelp tipWith:@"弹出一个框框" wait:1.2f];
}
- (IBAction)alertshow4:(id)sender {
    [AlertHelp alertWith:@"HHH" message:@"HHHHHH" funBtns:@{} cancelBtn:@"取消" destructiveBtn:@"哈哈哈" alertStyle:UIAlertControllerStyleAlert cancelAction:^(UIAlertAction * _Nonnull action) {
...
- (IBAction)alertshow5:(id)sender {
    ...
    [AlertHelp alertWith:@"我是标题" message:@"我是内容" funBtns:funs cancelBtn:@"取消" destructiveBtn:@"清空滤镜" alertStyle:UIAlertControllerStyleAlert cancelAction:nil destrutiveAction:^(UIAlertAction * _Nonnull action) {
...
//    [AlertHelp alertWith:@"" message:@"" funBtns:@{} cancelBtn:nil alertStyle:UIAlertControllerStyleAlert cancelAction:^(UIAlertAction * _Nonnull action) {
//
//    }];
}
